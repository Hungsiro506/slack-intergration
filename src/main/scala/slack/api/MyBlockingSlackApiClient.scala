...
object MyBlockingSlackApiClient {

  def apply(token: String, duration: FiniteDuration = 5.seconds,proxyHost: String, proxyPort: Int): MyBlockingSlackApiClient = {
    new MyBlockingSlackApiClient(token, duration,proxyHost: String, proxyPort: Int)
  }
...
class MyBlockingSlackApiClient(token: String, duration: FiniteDuration = 5.seconds,proxyHost: String, proxyPort: Int) {
  val client = new MySlackApiClient(token,proxyHost: String, proxyPort: Int)
